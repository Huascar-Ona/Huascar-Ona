/*jslint browser: true, onevar: true, undef: true, nomen: false, eqeqeq: true, bitwise: true, regexp: true, newcap: true, immed: true http://ssssnakes.com/smoke/*/
		...
		if (f.type !== 'signal'){
			...
			if (f.type === 'alert'){
				...
				if (f.params.reverseButtons) {
					buttons +=
						'<button id="'+f.type+'-cancel-'+f.newid+'" class="green button"  type="button">'+cancel+'</button>' +
						'<button id="'+f.type+'-ok-'+f.newid+'" class="green button"  type="button">'+ok+'</button>';				
				} else {
					buttons +=
						'<button id="'+f.type+'-ok-'+f.newid+'" class="green button"  type="button">'+ok+'</button>' +
						'<button id="'+f.type+'-cancel-'+f.newid+'" class="green button"  type="button">'+cancel+'</button>';
